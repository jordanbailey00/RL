...
- the first sim-owned flat training schema intentionally mirrors this current trainer layout so RL can remove Python raw-object reconstruction without simultaneously redesigning the policy feature set
